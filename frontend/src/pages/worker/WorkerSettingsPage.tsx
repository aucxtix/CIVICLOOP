          ...
          <Card className="border-none shadow-sm">
            ...
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="font-bold text-foreground text-sm">New Task Assignments</h4>
                  <p className="text-xs text-muted-foreground mt-0.5">Receive an alert when a new task is dispatched to you.</p>
                </div>
                <div 
                  className={`w-12 h-6 rounded-full cursor-pointer transition-colors relative ${notifications ? 'bg-primary' : 'bg-slate-200'}`}
              ...
              <div className="flex items-center justify-between border-t border-border pt-6">
                <div>
                  <h4 className="font-bold text-foreground text-sm">Route Updates</h4>
                  <p className="text-xs text-muted-foreground mt-0.5">Alerts about traffic or route changes while navigating.</p>
                </div>
                <div className="w-12 h-6 rounded-full cursor-pointer transition-colors relative bg-primary">
          ...
          <Card className="border-none shadow-sm">
            ...
            <CardContent>
              <form onSubmit={handleSave} className="space-y-4">
                ...
                <div className="pt-2">
                  <Button type="submit" className="font-bold">Update Password</Button>
                </div>
              </form>
            </CardContent>
          </Card>
